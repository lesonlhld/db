package momo.shared.utils;

import momo.shared.sharedmodels.HttpRequest;
...
public class Execute {
    ...
    public static Request createRequest(HttpRequest request) {
        RequestBody body = RequestBody.create(MediaType.parse(request.getContentType()), request.getPayload());
